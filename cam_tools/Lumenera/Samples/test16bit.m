...
%      =============================
%
% Descrition:  Test the LucamCaptureMonochromeFrame. and also remove 
% color % channel when using takevideo, takesnapshot and takefastframes 
% NOTES:
...
figure('Name','Histograme take video mono frame'), 
imhist(imcaptureMono);
 
figure('Name','Take snapshot mono frame'), imshow(imsnapMono); 
figure('Name','Histograme take snapshot mono frame'), 
imhist(imsnapMono);
 
figure('Name','Take fast frame mono frame'), imshow(imtakefastMono); 
figure('Name','Histograme take fast frame mono frame'), 
imhist(imtakefastMono);