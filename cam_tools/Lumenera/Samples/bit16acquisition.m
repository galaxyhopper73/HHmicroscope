...
LucamSetSnapshotExposure(25,1);
LucamSetSnapshotGain(1,1);
...
blue8=snap8(:,:,1);
%x=0:1:255;
%figure('Name','Test hist'),hist(green8,x);
figure('Name','Histograme green 8bit'),imhist(green8);
figure('Name','Green 8 bit'),imshow(green8);
...
green16=snap16(:,:,1);
blue16=snap16(:,:,1);
figure('Name','Histograme green 16bit'),imhist(green16);
figure('Name','Green 16 bit'),imshow(green16);
